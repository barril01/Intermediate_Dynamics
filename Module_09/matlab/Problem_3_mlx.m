...
display(dL_dtheta_1) %[output:7262416c]
dL_dtheta_1_dot = diff(L,theta_1_dot);
display(dL_dtheta_1_dot) %[output:3866dcf5]
dL_dtheta_1_dot_dt = simplify(diff(dL_dtheta_1_dot,t));
display(dL_dtheta_1_dot_dt) %[output:5b730de9]
% theta_2 coordinate derivatives
dL_dtheta_2     = diff(L,theta_2);
display(dL_dtheta_2) %[output:9b50404c]
dL_dtheta_2_dot = diff(L,theta_2_dot);
display(dL_dtheta_2_dot) %[output:216ad11d]
dL_dtheta_2_dot_dt = simplify(diff(dL_dtheta_2_dot,t));
display(dL_dtheta_2_dot_dt) %[output:7424b5bc]
...
display(EOM_1) %[output:3c527b3b]
display(EOM_2) %[output:8cc0e24c]
%[text] External force
...
display(Q_theta_2) %[output:9c24c2cf]
...
%---
%[output:7424b5bc]
%   data: {"dataType":"symbolic","outputData":{"name":"dL_dtheta_2_dot_dt(t)","value":"0.5000\\,m\\,{\\left(0.6667\\,{L_2 }^2 \\,\\frac{\\partial^2 }{\\partial t^2 }\\;\\theta_2 \\left(t\\right)+L_1 \\,L_2 \\,\\cos \\left(\\theta_1 \\left(t\\right)-\\theta_2 \\left(t\\right)\\right)\\,\\frac{\\partial^2 }{\\partial t^2 }\\;\\theta_1 \\left(t\\right)-L_1 \\,L_2 \\,\\sin \\left(\\theta_1 \\left(t\\right)-\\theta_2 \\left(t\\right)\\right)\\,{\\left(\\frac{\\partial }{\\partial t}\\;\\theta_1 \\left(t\\right)-\\frac{\\partial }{\\partial t}\\;\\theta_2 \\left(t\\right)\\right)}\\,\\frac{\\partial }{\\partial t}\\;\\theta_1 \\left(t\\right)\\right)}"}}
%---
%[output:3c527b3b]
