...
\begin{answer}
    $$ m\,L^2\,\ddot{\theta}+k_{p}\,\theta+\left(a-X''\left(t\right)\right)m\,L\sin\left(\theta\right) =  P(t)\ L \sin(\theta)   $$
\end{answer}

% Or:

% % $$ m\,L\,\ddot{\theta} -m\,a\,\sin\left(\theta \right)+k_{p}\,\theta  = P(t)\ \sin(\theta)   $$
% $$ m\,L\,\ddot{\theta}-m\,\sin\left(\theta\right)\,X''\left(t\right)-m\,a\,\sin\left(\theta\right)\,L+k_{p}\,\theta = L\ P(t)\ \sin(\theta)   $$
