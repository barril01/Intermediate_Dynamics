...
\begin{center}
    ...
    %Shape: Arc [id:dp43676387722362553] 
    \draw  [draw opacity=0] (137.95,127.94) .. controls (154.85,123.32) and (176.19,120.43) .. (199.41,120.15) .. controls (225.08,119.84) and (248.52,122.76) .. (266.26,127.81) -- (199.82,153.18) -- cycle ; \draw   (137.95,127.94) .. controls (154.85,123.32) and (176.19,120.43) .. (199.41,120.15) .. controls (225.08,119.84) and (248.52,122.76) .. (266.26,127.81) ;  
    %Shape: Circle [id:dp34836189390800176] 
    \draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (196,120.5) .. controls (196,118.01) and (198.01,116) .. (200.5,116) .. controls (202.99,116) and (205,118.01) .. (205,120.5) .. controls (205,122.99) and (202.99,125) .. (200.5,125) .. controls (198.01,125) and (196,122.99) .. (196,120.5) -- cycle ;
    %Straight Lines [id:da7688555301359179] 
    \draw  [dash pattern={on 4.5pt off 4.5pt}]  (112,121) -- (299,120) ;
    %Straight Lines [id:da7065463346451957] 
    \draw    (112,121) -- (200.5,120.5) ;
    %Straight Lines [id:da2912602822077428] 
    \draw    (112,121) -- (119,118) ;
    %Straight Lines [id:da16266471763282175] 
    \draw    (112,121) -- (118,125) ;
    %Straight Lines [id:da8499840717399565] 
    \draw    (201,164) -- (200.5,120.5) ;
    %Straight Lines [id:da47561513104380615] 
    \draw    (195,157) -- (201,164) ;
    %Straight Lines [id:da5340595821402228] 
    \draw    (201,164) -- (207,158) ;
    %Straight Lines [id:da3742473949950429] 
    \draw  [dash pattern={on 4.5pt off 4.5pt}]  (167.5,77) -- (233.5,164) ;
    %Straight Lines [id:da7318042246352303] 
    \draw    (200.5,120.5) -- (233.5,164) ;
    %Straight Lines [id:da5717504083889309] 
    \draw    (233.5,164) -- (233,154) ;
    %Straight Lines [id:da6288600911674769] 
    \draw    (225,163) -- (233.5,164) ;
    %Straight Lines [id:da3904137858589003] 
    \draw  [dash pattern={on 4.5pt off 4.5pt}]  (200.5,120.5) -- (246,92) ;
    %Curve Lines [id:da7164866059502566] 
    \draw    (171,121) .. controls (169,110) and (174,102) .. (182,96) ;
    
    % Text Node
    \draw (239,163.4) node [anchor=north west][inner sep=0.75pt]    {$F_{g}$};
    % Text Node
    \draw (192,165.4) node [anchor=north west][inner sep=0.75pt]    {$e_{n}$};
    % Text Node
    \draw (249,75.4) node [anchor=north west][inner sep=0.75pt]    {$e_{\theta }$};
    % Text Node
    \draw (153,54.4) node [anchor=north west][inner sep=0.75pt]    {$e_{R}$};
    % Text Node
    \draw (78,110.4) node [anchor=north west][inner sep=0.75pt]    {$e_t||v$};
    % Text Node
    \draw (174,103.4) node [anchor=north west][inner sep=0.75pt]    {$\theta $};
...
\subsubsection*{The disk spins about its axis CD at 1200 rev/min as the system rotates about the vertical axis at 20 rev/min.
...
\subsubsection*{The gyroscopic turn indicator consists of a 1-kg flywheel whose principal radii of gyration are $\bm{k_x =50}$ mm and $\bm{k_y = k_z = 40}$ mm.
...
\begin{answer}
    \begin{equation*}
        \begin{aligned}
            F_{A_y} &=  -3.8684\times 10^9 \ \textbf{N}\\
            F_{A_z} &=  -6666.7  \ \textbf{N}\\
            F_{B_y} &= 3.8684\times 10^9 \ \textbf{N}\\
            F_{B_z} &=  6666.7  \ \textbf{N}
    \end{aligned}
    \end{equation*}
\end{answer}
